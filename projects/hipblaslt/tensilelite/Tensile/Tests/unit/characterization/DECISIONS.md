...
## D23 — LibraryIO characterization: add-only mutation-kill snapshot cases
...
## D24 — Solution.py mutation kill: pickle-free `.ambr` derivation golden
...
discipline. Unlike the LibraryIO add-only cases in D23, this introduces a new
...
## D25 — Per-file ratchet baseline refresh after wave-2 (r8 + HUX crossover)

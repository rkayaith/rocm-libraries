...
class TestScanSpec:
    ...
    def test_lds_leaves_room_for_two_workgroups(self):
        ...
        CU there is no second workgroup to cover it, which is exactly the state
        the fused kernel is stuck in. So the occupancy target is a spec-level
        rejection rule here, not a tuning note.
        """
